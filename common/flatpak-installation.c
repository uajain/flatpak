 ...
 */
gboolean
flatpak_installation_get_min_free_space_bytes (FlatpakInstallation *self, guint64 *out_bytes, GError **error)
{
  g_autoptr(FlatpakDir) dir = NULL;
  g_autoptr(FlatpakDir) dir_clone = NULL;
  ...
  return ostree_repo_get_min_free_space_bytes (flatpak_dir_get_repo (dir), out_bytes, error);
}
